                ...
                {sessions.length === 0 ? (
                    ...
                    sessions.map((session) => {
                        ...
                        return (
                            ...
                            >
                                <svg className={`w-3 h-3 flex-shrink-0 ${isActive ? 'text-amber-500' : 'text-gray-300 dark:text-gray-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const CodingAgentUI = () => {
    ...
    return (
        <div className="flex h-full w-full overflow-hidden bg-gray-50/50 dark:bg-gray-900/10">
            ...
            {/* ── LEFT: History Panel ─────────────────────────────────── */}
            <div
                className={`flex-shrink-0 bg-white dark:bg-gray-800 border-r border-gray-100 dark:border-gray-700 overflow-hidden flex flex-col transition-all duration-300 ease-in-out ${
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button 
                                ...
                                disabled={isStreaming || isTransforming} 
                                className={`px-3 py-1.5 text-xs font-bold uppercase tracking-wider rounded border transition-all disabled:opacity-50 ${
                                    isTransforming ? 'bg-amber-500/10 text-amber-400 border-amber-500/20 animate-pulse' : 'bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 border-rose-500/20'
                                }`}
                            >
