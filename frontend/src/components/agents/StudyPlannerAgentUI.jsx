      ...
      <div className="animate-fade-in flex flex-col h-full">
        <header className="mb-8 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="flex items-center gap-6">
            <div className="w-16 h-16 rounded-2xl bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center text-3xl">📅</div>
            <div>
                        ...
                        >
                          ...
                          <td className="px-6 py-5">
                            <span className={`text-[9px] font-black uppercase tracking-widest px-2.5 py-1 rounded-lg ${
                              topic.difficulty === 'Easy' ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30' :
               ...
               return (
                 ...
                 >
                    ...
                    <div className="flex items-center justify-between mt-auto">
                       ...
                       <span className={`text-[9px] font-black uppercase tracking-widest px-2.5 py-1 rounded-lg ${
                          topic.difficulty === 'Easy' ? 'bg-emerald-50 text-emerald-600 dark:bg-emerald-900/20' :
