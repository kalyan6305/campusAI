...
const AgentsPage = () => {
    ...
    const [showStudyPlanHistory, setShowStudyPlanHistory] = useState(false);
            ...
            {!selectedAgent ? (
                <>
                    <header className="mb-6 text-center md:text-left">
                        <h1 className="text-3xl font-black text-gray-900 dark:text-gray-100 tracking-tight flex items-center gap-3 justify-center md:justify-start">
                            <span className="text-blue-600 dark:text-blue-400">Specialized</span> Agents
                        </h1>
                        <p className="mt-2 text-base text-gray-500 dark:text-gray-400 font-medium max-w-2xl">
                            Domain-specific AI assistants for academic and career success.
                        </p>
                    </header>
                ...
                <div className="flex-grow flex flex-col min-w-0 h-full">
                    <header className="mb-6 flex items-center justify-between gap-4">
                        ...
                        <div className="hidden sm:flex items-center gap-3">
                            ...
                            {/* Plan History button — only for study_planner */}
                            {selectedAgent === 'study_planner' && (
                                <button
                                    onClick={() => setShowStudyPlanHistory(prev => !prev)}
                        ...
                        <div className="flex-1 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden flex flex-col relative">
                            {selectedAgent === 'job-apply' ? (
                                ...
                                <React.Suspense fallback={<div className="flex items-center justify-center h-full"><div className="w-10 h-10 border-4 border-blue-500 border-t-transparent rounded-full animate-spin"></div></div>}>
                                    <StudyPlannerAgentUI showHistory={showStudyPlanHistory} setShowHistory={setShowStudyPlanHistory} />
                                </React.Suspense>
                            ) : (
                                <>
